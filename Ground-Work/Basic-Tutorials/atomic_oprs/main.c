...
*
* Tutorial Link: https://embetronicx.com/tutorials/linux/device-drivers/atomic-variables-atomic-operation/
*
* The core idea to use atomic variables is to eliminate the overhead introduced
