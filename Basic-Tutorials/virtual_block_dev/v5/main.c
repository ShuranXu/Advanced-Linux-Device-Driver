/**
 * 
 *  Virtual Block Device Driver Example for kernel Version 5.3+
 * 
 * Tutorial Link: https://olegkutkov.me/2020/02/10/linux-block-device-driver/
 * 
 * We can run 'sudo fdisk /dev/blockdev' to test the driver.
 */
